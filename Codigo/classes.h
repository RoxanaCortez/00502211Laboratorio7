...
enum parameters {const_t,const_k,const_d,const_lambda,const_y_X,const_y_Y,const_n};
...
class mesh{
    ...
    public:
        void setParameters(float t,float k,float d,float lambda,float y_X,float y_Y,float n){
            parameters[const_t]=t;
            parameters[const_k]=k;
            parameters[const_d]=d;
            parameters[const_lambda]=lambda;
            parameters[const_y_X]=y_X;
            parameters[const_y_Y]=y_Y;
